...
import dev.vale.typing.names.{CitizenNameT, CitizenTemplateNameT, CodeVarNameT, DenizenDefaultRegionNameT, FunctionNameT, FunctionTemplateNameT, IdT, StructNameT, StructTemplateNameT}
