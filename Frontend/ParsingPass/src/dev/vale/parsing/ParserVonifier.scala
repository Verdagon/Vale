...
//      }
  ...
  def vonifyIdentifyingRune(thing: GenericParameterP): VonObject = {
    val GenericParameterP(range, name, attributes, maybeDefault) = thing
    VonObject(
      "IdentifyingRune",
      None,
      Vector(
