#ifndef REGION_RAW_H_
#define REGION_RAW_H_

#include <regions/shared/stringmixin.h>
#include <regions/shared/immmixin.h>
#include "iregion.h"

class RawRegion : public IRegion {
public:
  RawRegion();
...
//      const std::vector<LLVMValueRef>& membersLE);
  ...
  LLVMValueRef getMutConcreteControlBlockPtr(
      LLVMBuilderRef builder,
      LLVMValueRef concretePtrLE);

  LLVMValueRef getMutInterfaceControlBlockPtr(
      LLVMBuilderRef builder,
