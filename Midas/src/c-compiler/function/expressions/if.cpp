...
LLVMValueRef translateIf(
  ...
  auto resultLE =
      buildIfElse(
          ...
          builder,
          conditionExpr,
          translateType(globalState, functionState->defaultRegion, iff->commonSupertype),
  ...
  functionState->defaultRegion->checkValidReference(FL(), globalState, functionState, builder, iff->commonSupertype, resultLE);
