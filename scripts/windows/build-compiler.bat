...
echo Running Tester...
build\testvalec --frontend_path .\BuiltValeCompiler\Frontend.jar --backend_path .\BuiltValeCompiler\backend.exe --builtins_dir .\BuiltValeCompiler\builtins --valec_path .\BuiltValeCompiler\valec.exe --stdlib_dir .\BuiltValeCompiler\stdlib --backend_tests_dir ..\Backend\test --frontend_tests_dir ..\Frontend --concurrent 6 @resilient-v3 || echo "Tests failed, aborting." && exit /b 1
