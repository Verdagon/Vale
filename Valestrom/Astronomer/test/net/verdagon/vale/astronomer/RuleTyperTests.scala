...
//            EqualsSR(
//              RangeS.testZero,
//              TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("__C"))),
//              TemplexSR(
//                InterpretedSR(RangeS.testZero,ConstraintP,ReadonlyP,NameSR(RangeS.testZero, CodeTypeNameS("ImmInterface")))))),
//          RangeS.testZero,
//          Vector.empty,
//          None)
//
...
//              TemplexSR(
//                InterpretedSR(
//                  RangeS.testZero,WeakP,ReadonlyP,NameSR(RangeS.testZero, CodeTypeNameS("ImmInterface")))))),
//          RangeS.testZero,
//          Vector.empty,
//          None)
//
...
//            EqualsSR(RangeS.testZero,TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("Z"))),TemplexSR(NameSR(RangeS.testZero, CodeTypeNameS("int"))))),
//          RangeS.testZero,
//          Vector.empty,
//          None)
//
...
//          makeCannedEnvironment(),
//          Vector(
//            EqualsSR(RangeS.testZero,TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("__RetRune"))),CallSR(RangeS.testZero,"toRef",Vector(TemplexSR(NameSR(RangeS.testZero, CodeTypeNameS("MutStruct"))))))),
//          RangeS.testZero,
//          Vector.empty,
//          None)
//
...
//          Vector(
//            TypedSR(RangeS.testZero,CodeRuneS("Z"),CoordTypeSR),
//            EqualsSR(RangeS.testZero,TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("Z"))),CallSR(RangeS.testZero,"toRef", Vector(TemplexSR(NameSR(RangeS.testZero, CodeTypeNameS("int"))))))),
//          RangeS.testZero,
//          Vector.empty,
//          None)
//
...
//              TemplexSR(CallSR(RangeS.testZero,NameSR(RangeS.testZero, CodeTypeNameS("MutTInterface")),Vector(RuneSR(RangeS.testZero,CodeRuneS("T"))))))),
//          RangeS.testZero,
//          Vector.empty,
//          None)
//
...
//              Vector(
//                TemplexSR(OwnershipSR(RangeS.testZero,OwnP)),
//                TemplexSR(PermissionSR(RangeS.testZero,ReadonlyP)),
//                TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("Q"))))),
//            TypedSR(RangeS.testZero,CodeRuneS("Z"),CoordTypeSR),
//            ComponentsSR(
//              RangeS.testZero,
//              TypedSR(RangeS.testZero,CodeRuneS("Z"),CoordTypeSR),
//              Vector(
//                TemplexSR(OwnershipSR(RangeS.testZero,ConstraintP)),
//                TemplexSR(PermissionSR(RangeS.testZero,ReadonlyP)),
//                TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("Q")))))),
//          RangeS.testZero,
...
//            EqualsSR(RangeS.testZero,TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("__Let0_"))),CallSR(RangeS.testZero,"toRef", Vector(TemplexSR(NameSR(RangeS.testZero, CodeTypeNameS("MutInterface"))))))),
//          RangeS.testZero,
...
//          Vector(
//            TypedSR(RangeS.testZero,CodeRuneS("__Let0_"),CoordTypeSR),
//            EqualsSR(RangeS.testZero,TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("__Let0_"))),CallSR(RangeS.testZero,"toRef", Vector(TemplexSR(CallSR(RangeS.testZero,NameSR(RangeS.testZero, CodeTypeNameS("MutTInterface")), Vector(RuneSR(RangeS.testZero,CodeRuneS("T"))))))))),
//          RangeS.testZero,
//          Vector(AtomSP(RangeS.testZero, Some(CaptureS(CodeVarNameS("x"))),None,CodeRuneS("__Let0_"),None)),
//          None)
//
...
//          TypedSR(RangeS.testZero,CodeRuneS("T"),CoordTypeSR),
//          Vector(
//            OrSR(RangeS.testZero,Vector(TemplexSR(OwnershipSR(RangeS.testZero,OwnP)), TemplexSR(OwnershipSR(RangeS.testZero,ShareP)))),
//            TemplexSR(PermissionSR(RangeS.testZero,ReadonlyP)),
//            CallSR(RangeS.testZero,"passThroughIfConcrete",Vector(TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("Z"))))))),
//        EqualsSR(RangeS.testZero,TypedSR(RangeS.testZero,CodeRuneS("V"),CoordTypeSR),CallSR(RangeS.testZero,"toRef",Vector(TemplexSR(NameSR(RangeS.testZero, CodeTypeNameS("void")))))))
//    val atoms =
...
//            OrSR(RangeS.testZero,Vector(TemplexSR(OwnershipSR(RangeS.testZero,OwnP)), TemplexSR(OwnershipSR(RangeS.testZero,ShareP)))),
//            TemplexSR(PermissionSR(RangeS.testZero,ReadonlyP)),
//            CallSR(RangeS.testZero,"passThroughIfInterface",Vector(TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("Z"))))))),
//        EqualsSR(RangeS.testZero,TypedSR(RangeS.testZero,CodeRuneS("V"),CoordTypeSR),CallSR(RangeS.testZero,"toRef",Vector(TemplexSR(NameSR(RangeS.testZero, CodeTypeNameS("void")))))))
//    val atoms =
//      Vector(AtomSP(RangeS.testZero, Some(CaptureS(CodeVarNameS("this"))),None,CodeRuneS("T"),None))
//
...
//            OrSR(RangeS.testZero,Vector(TemplexSR(OwnershipSR(RangeS.testZero,OwnP)), TemplexSR(OwnershipSR(RangeS.testZero,ShareP)))),
//            TemplexSR(PermissionSR(RangeS.testZero,ReadonlyP)),
//            CallSR(RangeS.testZero,"passThroughIfStruct",Vector(TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("Z"))))))))
//    val atoms =
//      Vector(AtomSP(RangeS.testZero, Some(CaptureS(CodeVarNameS("this"))),None,CodeRuneS("T"),None))
//
...
//        TypedSR(RangeS.testZero,CodeRuneS("Z"),CoordTypeSR),
//        EqualsSR(RangeS.testZero,
//          TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("Z"))),
//          TemplexSR(CallSR(RangeS.testZero,NameSR(RangeS.testZero, CodeTypeNameS("MutTStruct")),Vector(NameSR(RangeS.testZero, CodeTypeNameS("int")))))))
//    val atoms =
//      Vector(AtomSP(RangeS.testZero, Some(CaptureS(CodeVarNameS("this"))),None,CodeRuneS("T"),None))
//
//    val (conclusions, RuleTyperSolveSuccess(_)) =
...
//        EqualsSR(RangeS.testZero,
//          TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("Z"))),
//          TemplexSR(CallSR(RangeS.testZero,NameSR(RangeS.testZero, CodeTypeNameS("MutTStruct")),Vector(InterpretedSR(RangeS.testZero,ShareP,ReadonlyP,NameSR(RangeS.testZero, CodeTypeNameS("int"))))))))
//    val atoms =
//      Vector(AtomSP(RangeS.testZero, Some(CaptureS(CodeVarNameS("this"))),None,CodeRuneS("T"),None))
//
//    val (conclusions, RuleTyperSolveSuccess(_)) =
...
//        EqualsSR(RangeS.testZero,TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("__Par0"))),TemplexSR(NameSR(RangeS.testZero, CodeTypeNameS("MutStruct")))))
//    val atoms =
//      Vector(AtomSP(RangeS.testZero, Some(CaptureS(CodeVarNameS("this"))),None,CodeRuneS("T"),None))
//
//    val (conclusions, RuleTyperSolveSuccess(_)) =
...
//      Vector(
//        TypedSR(RangeS.testZero,CodeRuneS("Z"),CoordTypeSR),
//        EqualsSR(RangeS.testZero,TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("Z"))),TemplexSR(CallSR(RangeS.testZero,NameSR(RangeS.testZero, CodeTypeNameS("MutTStruct")),Vector(RuneSR(RangeS.testZero,CodeRuneS("T")))))))
//
//    val (conclusions, RuleTyperSolveSuccess(_)) =
...
//              RepeaterSequenceSR(
//                RangeS.testZero,
//                MutabilitySR(RangeS.testZero,MutableP),
//                VariabilitySR(RangeS.testZero,VaryingP),
//                IntSR(RangeS.testZero,5),InterpretedSR(RangeS.testZero,ShareP,ReadonlyP,NameSR(RangeS.testZero, CodeTypeNameS("int"))))))),
//        RangeS.testZero,
//        Vector.empty,
//        None)
//    conclusions.typeByRune(CodeRuneA("Z")) shouldEqual CoordTemplataType
...
//            TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("Z"))),
//            TemplexSR(
//              ManualSequenceSR(RangeS.testZero,
//                Vector(
//                  InterpretedSR(RangeS.testZero,ShareP,ReadonlyP, NameSR(RangeS.testZero, CodeTypeNameS("int"))),
//                  InterpretedSR(RangeS.testZero,ShareP,ReadonlyP, NameSR(RangeS.testZero, CodeTypeNameS("int")))))))),
//        RangeS.testZero,
//        Vector.empty,
//        None)
...
//            TypedSR(RangeS.testZero,CodeRuneS("K"), KindTypeSR),
//            TemplexSR(
//              CallSR(RangeS.testZero,NameSR(RangeS.testZero, CodeTypeNameS("Array")),Vector(MutabilitySR(RangeS.testZero,MutableP), VariabilitySR(RangeS.testZero,VaryingP), NameSR(RangeS.testZero, CodeTypeNameS("int")))))),
//          EqualsSR(RangeS.testZero,
//            TypedSR(RangeS.testZero,CodeRuneS("K"), KindTypeSR),
//            TemplexSR(CallSR(RangeS.testZero,NameSR(RangeS.testZero, CodeTypeNameS("Array")),Vector(RuneSR(RangeS.testZero,CodeRuneS("M")), RuneSR(RangeS.testZero,CodeRuneS("V")), RuneSR(RangeS.testZero,CodeRuneS("T"))))))),
//        RangeS.testZero,
//        Vector.empty,
//        None)
...
//              TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("K"))),
//              TemplexSR(NameSR(RangeS.testZero, CodeTypeNameS("MutInterface"))))),
//          RangeS.testZero,
//          Vector.empty,
//          None)
...
//              Vector(
//                TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("A"))),
//                TemplexSR(PackSR(RangeS.testZero,Vector(RuneSR(RangeS.testZero,CodeRuneS("B"))))),
//                TemplexSR(RuneSR(RangeS.testZero,CodeRuneS("C")))))),
//          RangeS.testZero,
//          Vector.empty,
//          None)
