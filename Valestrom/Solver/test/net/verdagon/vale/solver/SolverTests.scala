...
//  }
  ...
  FailedSolve[String, String] = {
    val (tentativeRuneToCanonicalRune, world) = Optimizer.optimize(builder, makePuzzler())
    val (orderedCanonicalRules, canonicalRuneToIsSolved) = Planner.solveAndReorder(world, Nil)
