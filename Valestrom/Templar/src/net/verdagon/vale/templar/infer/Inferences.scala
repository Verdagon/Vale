...
//import net.verdagon.vale.templar.IRuneS
...
//    runeToType: Map[IRuneT, ITemplataType], // Here for doublechecking
...
//    (runeToType.get(rune), templata) match {
//      case (None, _) =>
...
//    val inferencesWithoutThatRune = Inferences(runeToType, templatasByRune, possibilitiesByRune - rune)
