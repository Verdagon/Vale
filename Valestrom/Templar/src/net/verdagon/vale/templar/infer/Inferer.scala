...
import net.verdagon.vale.{IProfiler, Ok, vimpl}
...
//    val equalsLayer = new InfererEquator[Env, State](delegate)
//
//    val solverEnv =
//      TemplarSolverEnv(
//
...
//      }
//
//      override def lookupTemplataImprecise(env: Env, range: RangeS, name: INameS): ITemplata = {
