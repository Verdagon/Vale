#ifndef REGION_SAFE_FASTEST_SAFE_FASTEST_H_
#define REGION_SAFE_FASTEST_SAFE_FASTEST_H_
...
class SafeFastest : public IRegion {
public:
  SafeFastest(GlobalState* globalState);
  ~SafeFastest() override = default;
...
//  WrcWeaks wrcWeaks;
  ...
  std::string namePrefix = "__SafeFastest";
