#ifndef REGION_NAIVERC_NAIVERC_H_
#define REGION_NAIVERC_NAIVERC_H_
...
class NaiveRC : public IRegion {
public:
  NaiveRC(GlobalState* globalState, RegionId* regionId);
  ~NaiveRC() override = default;
...
//  }
  LLVMValueRef getStringBytesPtr(
    ...
    auto strWrapperPtrLE = ref.inner;
...
protected:
  ...
  std::string namePrefix = "__NaiveRC";
